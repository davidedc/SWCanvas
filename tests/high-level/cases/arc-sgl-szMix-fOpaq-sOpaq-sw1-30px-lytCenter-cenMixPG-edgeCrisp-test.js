 ...
 * | StrokeThickness        | 1px-30px           | Stroke width is randomized within calculateArcTestParameters, resulting in a range of 1-30px.
...
registerHighLevelTest(
    'arc-sgl-szMix-fOpaq-sOpaq-sw1-30px-lytCenter-cenMixPG-edgeCrisp-test',
